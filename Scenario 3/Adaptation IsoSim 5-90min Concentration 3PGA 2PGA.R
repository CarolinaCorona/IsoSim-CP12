...
cat("
    This code calculates the flux through 3PG <-> 2PG in 6 Synechocystis strains5-90 mins with new upper flux bound to dcp12
    \n \n")
...
setwd(wd)
if (!file.exists("Run-3pg-2pg-10-concentrations-5-90-upper100")){
  dir.create(file.path(wd, "Run-3pg-2pg-10-concentrations-5-90-upper100"))
}
setwd(file.path(wd, "Run-3pg-2pg-10-concentrations-5-90-upper100"))
...
cat("\n Modified: concentrations are updated according to empirical data 5-90 mins 3pg-2pg. Nwe upper bound for dcp12 100. \n\n")
####################################
...
original_data_input <- cbind("WTK_PG3_1-2-3"=c(0, 0, 0, 0, 0, 0),
                             "dcp12_PG3_1-2-3"=c(0,0.00397159,0.011314637,0.062717565,0.241552885,0.337020845),
                             "dcp12cp12_PG3_1-2-3"=c(0, 0, 0, 0, 0.001792413, 0.00084248),
                             "dcp12cp12dCysC_PG3_1-2-3"=c(0, 0, 0.00304893, 0.050659085, 0.0441527275, 0.0458769425),
                             "dcp12cp12dCysN_PG3_1-2-3"=c(0, 0, 0, 0, 0, 0),
                             "dcp12cp12dCysNC_PG3_1-2-3"=c(0, 0, 0.0161069625, 0.077143535, 0.219639593333333, 0.233304856666667))
...
enr_PG2_dcp12 <- c(0, 0.0010236875, 0.005175985, 0.1018379825, 0.2487054925, 0.3470264875)
...
# 13C-enrichments of metabolic intermediates (PG2A, PEP)
enr_PG2_dcp12_cp12 <- c(0, 0, 0, 0, 0.000253238, 0.003050705)
...
# 13C-enrichments of metabolic intermediates (PG2A, PEP)
enr_PG2_dcp12_cp12dCysC <- c(0, 0, 0.0067180525, 0.0495900833333333, 0.0565733, 0.0485604875)
...
# 13C-enrichments of metabolic intermediates (PG2A, PEP)
enr_PG2_dcp12_cp12dCysN <- c(0, 0, 0, 0, 0, 0)
...
# 13C-enrichments of metabolic intermediates (PG2A, PEP)
enr_PG2_dcp12_cp12dCysNC <- c(0, 0, 0.011180058, 0.076752798, 0.204328553, 0.24085604)
...
sd_dcp12 <- list(
  "3PG"=c(0, 0.00794318, 0.010755359, 0.043902583, 0.03444038, 0.044244396),
  "2PG"=c(0, 0.002047375, 0.007319948, 0.034679842, 0.043441443, 0.075407513)
)
...
sd_dcp12_cp12 <- list(
  "3PG"=c(0, 0, 0, 0, 0.003584825,	0.00168496),
...
sd_dcp12_cp12dCysC <- list(
  "3PG"=c(0, 0, 0.003532703, 0.009230331, 0.030750634, 0.009451074),
...
sd_dcp12_cp12dCysNC <- list(
  "3PG"=c(0, 0, 0.018721401, 0.030749119, 0.02480931, 0.050393998),

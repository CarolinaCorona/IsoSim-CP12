...
setwd(wd)
if (!file.exists("Run-all-10-no-concentrations-upper100")){
  dir.create(file.path(wd, "Run-all-10-no-concentrations-upper100"))
}
setwd(file.path(wd, "Run-all-10-no-concentrations-upper100"))
...
####################################
cat("\n   ... construct isotopic model of the 3PGA - 2PGA - PEP ...\n\n")
####################################
...
meta_conc_wt <- c("PG3"=8.2113, "PG2"=0.0367, "PEP"=4.958) #Most os Sebastian initial met concentr. 1.100000e-01 or 1.100000e-02
#    fluxes
kp_wt <- c("v1"=0)
#    sd of measurements
...
# initial parameters
#    metabolite concentrations
meta_conc_dcp12 <- c("PG3"=8.6006, "PG2"=0.0546, "PEP"=5.806) #Most os Sebastian initial met concentr. 1.100000e-01 or 1.100000e-02
#    fluxes
kp_dcp12 <- c("v1"=1)
#    sd of measurements
...
# initial parameters
#    metabolite concentrations
meta_conc_dcp12_cp12 <- c("PG3"=6.966, "PG2"=0.038, "PEP"=4.1426) #Most os Sebastian initial met concentr. 1.100000e-01 or 1.100000e-02
#    fluxes
...
# initial parameters
#    metabolite concentrations
meta_conc_dcp12_cp12dCysC <- c("PG3"=5.728, "PG2"=0.0706, "PEP"=4.1426) #Most os Sebastian initial met concentr. 1.100000e-01 or 1.100000e-02
#    fluxes
...
# initial parameters
#    metabolite concentrations
meta_conc_dcp12_cp12dCysN <- c("PG3"=6.446, "PG2"=0.04, "PEP"=4.84) #Most os Sebastian initial met concentr. 1.100000e-01 or 1.100000e-02
#    fluxes
...
# initial parameters
#    metabolite concentrations
meta_conc_dcp12_cp12dCysNC <- c("PG3"=6.3646, "PG2"=0.0367, "PEP"=4.8573) #Most os Sebastian initial met concentr. 1.100000e-01 or 1.100000e-02
#    fluxes
...
# pdf(paste0("Fig_All_WT_dcp12_dcp12cp12_",RUN,".pdf", sep=""))
# par(mfrow = c(3,3))
...
#   data_wt_offset <- data_exp_wt[,i+1] + epsilon
...
#   lines(times, resF_wt$result$retres$sim[, i] + epsilon, col=col_f[1])
# }
# 
...
# eval(parse(text=paste("fe=function(t){", anFun_fit_wt[[4]], "}", sep=""))) #anFun_fit_wt[[2]]
...
# for (i in seq(ncol(data_exp_dcp12[,-1]))) {
#   met <- c("2PG","PEP")[i]
#   
#   # Add small offset to zero values for plotting
#   data_dcp12_offset <- data_exp_dcp12[,i+1] + epsilon
...
#   lines(times, resF_dcp12$result$retres$sim[, i] + epsilon, col=col_f[2])
# }
# 
# # Additional plot for "3PG"
# met = "3PG"
...
# for (i in seq(ncol(data_exp_dcp12_cp12[,-1]))) {
#   met <- c("2PG","PEP")[i]
#   
#   # Add small offset to zero values for plotting
#   data_dcp12_cp12_offset <- data_exp_dcp12_cp12[,i+1] + epsilon
...
#   lines(times, resF_dcp12_cp12$result$retres$sim[, i] + epsilon, col=col_f[3])
# }
# 
# # Additional plot for "3PG"
# met = "3PG"
...
# # dcp12::cp12dCysC
# 
# pdf(paste("Fig_All_dcp12_cp12dCysC_N_NC_",RUN,".pdf", sep=""))
# par(mfrow = c(3,3))
# 
# # Small offset to avoid plotting issues with zero-only values
# epsilon <- 1e-6
...
# # Main plot loop for dcp12::cp12
# for (i in seq(ncol(data_exp_dcp12_cp12dCysC[,-1]))) {
#   met <- c("2PG","PEP")[i]
#   
#   # Add small offset to zero values for plotting
#   data_dcp12_cp12dCysC_offset <- data_exp_dcp12_cp12dCysC[,i+1] + epsilon
...
#   lines(times, resF_dcp12_cp12dCysC$result$retres$sim[, i] + epsilon, col=col_f[4])
# }
# 
# # Additional plot for "3PG"
# met = "3PG"
...
# # Main plot loop for dcp12::cp12
# for (i in seq(ncol(data_exp_dcp12_cp12dCysN[,-1]))) {
#   met <- c("2PG","PEP")[i]
#   
#   # Add small offset to zero values for plotting
#   data_dcp12_cp12dCysN_offset <- data_exp_dcp12_cp12dCysN[,i+1] + epsilon
...
#   lines(times, resF_dcp12_cp12dCysN$result$retres$sim[, i] + epsilon, col=col_f[5])
# }
# 
# # Additional plot for "3PG"
# met = "3PG"
...
# # Main plot loop for dcp12::cp12
# for (i in seq(ncol(data_exp_dcp12_cp12dCysNC[,-1]))) {
#   met <- c("2PG","PEP")[i]
#   
#   # Add small offset to zero values for plotting
#   data_dcp12_cp12dCysNC_offset <- data_exp_dcp12_cp12dCysNC[,i+1] + epsilon
...
#   lines(times, resF_dcp12_cp12dCysNC$result$retres$sim[, i] + epsilon, col=col_f[6])
# }
# 
# # Additional plot for "3PG"
# met = "3PG"

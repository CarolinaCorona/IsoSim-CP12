...
setwd(wd)
if (!file.exists("Run-2pg-pep-10-no-concentrations-upper100")){
  dir.create(file.path(wd, "Run-2pg-pep-10-no-concentrations-upper100"))
}
setwd(file.path(wd, "Run-2pg-pep-10-no-concentrations-upper100"))
...
meta_conc_wt <- c("PG2"=0.0367, "PEP"=4.958)
#    fluxes
kp_wt <- c("v1"=0)
#    sd of measurements
...
# initial parameters
#    metabolite concentrations
meta_conc_dcp12 <- c("PG2"=0.0546, "PEP"=5.806)
#    fluxes
kp_dcp12 <- c("v1"=1)
#    sd of measurements
...
# initial parameters
#    metabolite concentrations
meta_conc_dcp12_cp12 <- c("PG2"=0.038, "PEP"=4.1426) 
#    fluxes
...
# initial parameters
#    metabolite concentrations
meta_conc_dcp12_cp12dCysC <- c("PG2"=0.0706, "PEP"=4.1426) 
#    fluxes
...
# initial parameters
#    metabolite concentrations
meta_conc_dcp12_cp12dCysN <- c("PG2"=0.04, "PEP"=4.84) 
#    fluxes
...
# initial parameters
#    metabolite concentrations
meta_conc_dcp12_cp12dCysNC <- c("PG2"=0.0367, "PEP"=4.8573) 
#    fluxes

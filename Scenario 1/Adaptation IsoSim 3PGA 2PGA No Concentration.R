...
setwd(wd)
if (!file.exists("Run-3pg-2pg-10-no-concentrations-upper100")){
  dir.create(file.path(wd, "Run-3pg-2pg-10-no-concentrations-upper100"))
}
setwd(file.path(wd, "Run-3pg-2pg-10-no-concentrations-upper100"))
...
meta_conc_wt <- c("PG3"=8.2113, "PG2"=0.0367)
#    fluxes
kp_wt <- c("v1"=0)
#    sd of measurements
...
# initial parameters
#    metabolite concentrations
meta_conc_dcp12 <- c("PG3"=8.6006, "PG2"=0.0546)
#    fluxes
kp_dcp12 <- c("v1"=1)
#    sd of measurements
...
# initial parameters
#    metabolite concentrations
meta_conc_dcp12_cp12 <- c("PG3"=6.966, "PG2"=0.038) 
#    fluxes
...
# initial parameters
#    metabolite concentrations
meta_conc_dcp12_cp12dCysC <- c("PG3"=5.728, "PG2"=0.0706) 
#    fluxes
...
# initial parameters
#    metabolite concentrations
meta_conc_dcp12_cp12dCysN <- c("PG3"=6.446, "PG2"=0.04) 
#    fluxes
...
# initial parameters
#    metabolite concentrations
meta_conc_dcp12_cp12dCysNC <- c("PG3"=6.3646, "PG2"=0.0367) 
#    fluxes
